    ...
    this.state = {
      ...
      navLinks: [
        ...
        { id: 1, title: "Home", link: "/" },
        {
          ...
          isOpenSubMenu: false,
          child: [
            { id: 1, title: "Accounts", link: "/index-customer" },
            {
              id: 2,
              title: "Auth Pages",
              link: "/#",
          ...
          <Container>
            <div>
              <Link className="logo" to="/index">
                ...
                {<span style={{fontSize:"10px !important"}}>SCHOLIBS</span>}
              </Link>
            </div>
            {(() => {
